...
<body>
    <h1>{{ $title }}</h1>
    <p class="date">Generated: {{ $date }} | Lesson 10: Middleware</p>

    <div class="intro-box">
        <strong>Routes Overview:</strong> This document lists all {{ count($routes) }} routes defined in the Lesson 10 practice application, including their HTTP methods, paths, middleware configuration, and descriptions.
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="path-column">{{ $route['path'] }}</td>
                <td class="middleware-column">{{ $route['middleware'] }}</td>
