...
<body>
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="pdf-grid">
                <a href="{{ route('pdf.lesson10.complete') }}" class="pdf-card">
        ...
        <div class="section">
            ...
            <div class="pdf-grid">
                <a href="{{ route('pdf.lesson10.middleware') }}" class="pdf-card">
                ...
                <a href="{{ route('pdf.lesson10.code') }}" class="pdf-card">
                    <h3>Code Examples</h3>
                ...
                <a href="{{ route('pdf.lesson10.routes') }}" class="pdf-card">
        ...
        <div class="section">
            ...
            <div class="pdf-grid">
                <a href="{{ route('pdf.md.all') }}" class="pdf-card" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
            ...
            <div class="pdf-grid">
                <a href="{{ route('pdf.md.readme') }}" class="pdf-card">
                    <h3>README (Arabic)</h3>
                ...
                <a href="{{ route('pdf.md.quick-ref') }}" class="pdf-card">
                ...
                <a href="{{ route('pdf.md.practice-ar') }}" class="pdf-card">
            ...
            <div class="pdf-grid">
                <a href="{{ route('pdf.md.readme-en') }}" class="pdf-card">
                ...
                <a href="{{ route('pdf.md.quick-ref-en') }}" class="pdf-card">
                ...
                <a href="{{ route('pdf.md.practice-en') }}" class="pdf-card">
            ...
            <div class="pdf-grid">
                <a href="{{ route('pdf.md.exam') }}" class="pdf-card">
        ...
        <div class="section">
            ...
            <div class="pdf-grid">
                <a href="{{ route('pdf.sample') }}" class="pdf-card">
                    <h3>Sample PDF</h3>
                    <p>Basic PDF example demonstrating simple content generation.</p>
                    <span class="pdf-icon">👁️ View PDF</span>
                </a>

                <a href="{{ route('pdf.invoice') }}" class="pdf-card">
                    <h3>Invoice PDF</h3>
                    <p>Professional invoice template with tables and styling.</p>
                    <span class="pdf-icon">📥 Download PDF</span>
                </a>

                <a href="{{ route('pdf.landscape') }}" class="pdf-card">
                    <h3>Landscape PDF</h3>
