...
function markdownToPdfMpdf($markdownFile, $pdfFile, $isArabic = false) {
    ...
    <head>
        <meta charset="UTF-8">
        <title>Practice Guide - Lesson 1</title>
        ' . $css . '
    </head>
    <body>
        ' . $html . '
...
try {
    ...
    markdownToPdfMpdf(
        'lessons/lesson-01/PRACTICE-GUIDE-AR.md',
        'lessons/lesson-01/PRACTICE-GUIDE-Arabic.pdf',
        true
    );
    echo "\n";
    ...
    markdownToPdfMpdf(
        'lessons/lesson-01/PRACTICE-GUIDE-EN.md',
        'lessons/lesson-01/PRACTICE-GUIDE-English.pdf',
        false
    );
    echo "\n";
    ...
    echo "\n📁 Files created:\n";
    echo "  - lessons/lesson-01/PRACTICE-GUIDE-Arabic.pdf\n";
    echo "  - lessons/lesson-01/PRACTICE-GUIDE-English.pdf\n";
